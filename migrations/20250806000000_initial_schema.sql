...
INSERT INTO service_accounts (name, pass, description) VALUES
    ('admin', '$2b$12$dJu.mI5EjT6YX2buNJ2F4OLbp9RgvhqKH03KDUMfKScaWzCvxQVze', 'Default administrator account')
ON CONFLICT (name) DO NOTHING;
